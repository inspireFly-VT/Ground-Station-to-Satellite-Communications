...
def encode_ax25_frame(data: bytes, dest_callsign: str, source_callsign: str, operation: bytes) -> bytes:
    """
...
# Added data to the return statement for testing        
    return operatingMode, fcsCorrect, data
